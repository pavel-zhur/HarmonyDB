...
public class PolySequenceBlock : IPolyBlock
{
    ...
    public IReadOnlyList<PolySequenceBlock> Children { get; init; }
    ...
    public BlockType Type => BlockType.PolySequence;
    
    /// <summary>
    /// Whether self overlaps were detected among blocks with the same <see cref="Normalized"/> and <see cref="NormalizationRoot"/>.
    /// </summary>
