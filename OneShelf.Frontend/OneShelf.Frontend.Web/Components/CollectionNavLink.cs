...
/// </summary>
public class CollectionNavLink : ComponentBase, IDisposable
{
    ...
    [Parameter]
    public required bool IsMy { get; set; }
    ...
    [Inject] private IdentityProvider IdentityProvider { get; set; } = default!;
    [Inject] private CollectionNavigation CollectionNavigation { get; set; } = default!;
    ...
    protected override void OnParametersSet()
    {
        ...
        _hrefAbsolute = NavigationManager.ToAbsoluteUri("collection").AbsoluteUri;
    ...
    private bool ShouldMatch(string currentUriAbsolute)
    {
        ...
        if (IdentityProvider.Identity == null) return false;
        if (currentUriAbsolute.Contains(CollectionNavigation.GetMyContainedString()) != IsMy) return false;
