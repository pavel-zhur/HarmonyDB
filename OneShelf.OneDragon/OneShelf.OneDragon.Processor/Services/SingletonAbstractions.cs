...
public class SingletonAbstractions : ISingletonAbstractions
{
    ...
    public Markdown GetHelpResponseHeader()
    {
        ...
        result.AppendLine();
        result.AppendLine("Каждому пользователю телеграма доступен небольшой бесплатный лимит: примерно 30 сообщений, 5 картинок, 5 штук 30-секундной музыки в день, и 10 секунд видео в неделю. Использовать сервис сверх лимита пока нельзя, но напишите @pavel_zhur, если хотите.");
        result.AppendLine();
