...
public class SingletonAbstractions : ISingletonAbstractions
{
    ...
    {
        var result = new Markdown();
        result.AppendLine("Привет! Спасибо, что написали мне. Я — собака-GPT-чатбот (GPT-4o) 🐶. Могу вести текстовые диалоги и создавать изображения с помощью DALL-E 3 — самых свежих ИИ-моделей на сегодня (август 2024). Обожаю играть с текстами и картинками!");
        result.AppendLine();
