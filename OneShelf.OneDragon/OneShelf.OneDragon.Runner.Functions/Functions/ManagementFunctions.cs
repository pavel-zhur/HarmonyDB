...
namespace OneShelf.OneDragon.Runner.Functions.Functions
{
    public class ManagementFunctions
    {
        ...
        public ManagementFunctions(ILogger<ManagementFunctions> logger, IOptions<TelegramOptions> telegramOptions, DragonDatabase dragonDatabase)
        {
            _logger = logger;
        ...
        public async Task<HttpResponseData> CheckDb([HttpTrigger(AuthorizationLevel.Function, "get")] HttpRequestData req)
        {
            ...
            await response.WriteStringAsync($"Welcome to Azure Functions! Users Count = {await _dragonDatabase.Users.CountAsync()}");
        ...
        public async Task<HttpResponseData> MigrateDb([HttpTrigger(AuthorizationLevel.Function, "get")] HttpRequestData req)
        {
            ...
            await _dragonDatabase.Database.MigrateAsync();
