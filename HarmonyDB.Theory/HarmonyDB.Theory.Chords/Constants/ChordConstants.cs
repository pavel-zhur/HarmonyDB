...
public static class ChordConstants
{
    ...
    [
        ...
        (ChordMainType.Power, "5", MatchCase.ExactOnly, MatchAmbiguity.Degree),
    ...
    [
        (ChordTypeExtension.X7, "add7", MatchCase.MatchAny, MatchAmbiguity.Degree),
        ...
        (ChordTypeExtension.XMaj9, "maj9", MatchCase.MatchAny, MatchAmbiguity.Safe),
        ...
        (ChordTypeExtension.XMaj11, "maj11", MatchCase.MatchAny, MatchAmbiguity.Safe),
        (ChordTypeExtension.XMaj11, "M11", MatchCase.ExactOnly, MatchAmbiguity.Safe),

        (ChordTypeExtension.XMaj13, "maj13", MatchCase.MatchAny, MatchAmbiguity.Safe),
    ...
    [
        ...
        (ChordTypeAdditions.Add2, "add2", MatchCase.MatchAny, MatchAmbiguity.Degree),

        (ChordTypeAdditions.Add4, "4", MatchCase.ExactOnly, MatchAmbiguity.Degree),
        (ChordTypeAdditions.Add4, "add4", MatchCase.MatchAny, MatchAmbiguity.Degree),
        ...
        (ChordTypeAdditions.Add6, "add6", MatchCase.MatchAny, MatchAmbiguity.Degree),

        (ChordTypeAdditions.Add9, "add9", MatchCase.MatchAny, MatchAmbiguity.Degree),
        (ChordTypeAdditions.Add11, "add11", MatchCase.MatchAny, MatchAmbiguity.Degree),
        (ChordTypeAdditions.Add13, "add13", MatchCase.MatchAny, MatchAmbiguity.Degree),
    ];
    ...
    [
        ...
        (ChordTypeAmbiguousAddition.Add9And11, "add9,11", MatchCase.MatchAny, MatchAmbiguity.Safe),
    ];
